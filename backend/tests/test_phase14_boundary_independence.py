"""Phase 14 architectural decoupling and boundary independence tests."""
...
def test_analyzer_phase14_modules_have_zero_backend_imports():
    """Verify analyzer/config, analyzer/reporting, and all Phase 14 modules have ZERO forbidden imports."""
    violations = []
