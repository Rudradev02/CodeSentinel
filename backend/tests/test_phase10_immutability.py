...
@pytest.mark.asyncio
async def test_snapshot_immutability_across_multiple_runs(db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_repository_update_does_not_mutate_snapshot(db_session: AsyncSession):
