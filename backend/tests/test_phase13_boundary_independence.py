"""Phase 13 architectural decoupling and boundary independence tests."""
...
def test_analyzer_phase13_modules_have_zero_backend_imports():
    """Verify analyzer/dataflow and all new Phase 13 modules have ZERO forbidden imports."""
    violations = []
